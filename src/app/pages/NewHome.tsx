...
import { ArrowRight, Truck, Shield, HeadphonesIcon, Star, Clock, ChevronLeft, ChevronRight, Heart, ShoppingCart } from 'lucide-react';
import { useState, useEffect, ReactNode } from 'react';

function GlassCard({ children, className = '', hover = false }: { children: ReactNode; className?: string; hover?: boolean }) {
  return (
    <div
      className={`
...
function HeroSlider({ images }: { images: { src: string; alt: string; caption?: string; subcaption?: string }[] }) {
      ...
      <div className="relative rounded-2xl overflow-hidden bg-white/70 backdrop-blur-lg border border-white/30 shadow-lg transition-all duration-300 hover:scale-[1.03] hover:shadow-xl">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            {originalPrice && <span className="text-sm text-[var(--muted-foreground)] line-through">${originalPrice.toFixed(2)}</span>}
          </div>

          {!inStock && <p className="text-sm text-[var(--destructive)]">Out of Stock</p>}
        </div>
      </div>
    </div>
  );
...
export function NewHome() {
  ...
  const featuredProducts = [
    {
      id: '1',
      name: 'FLORA GLOBE EMS Neck Lifting and Facial Massager Skin Tightening Device',
      price: 89.99,
    ...
    },
    {
      ...
      inStock: true,
      category: 'electronic',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777197455/pro1_zodhoa.webp',
    },
    {
      id: '3',
      name: 'Bloom Picks Şarjlı Araç Süpürgesi - 2si 1 Arada Güçlü Vakum ve Hava Üfleme Kablosuz El Süpürgesi',
      price: 399.99,
      ...
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287406/3_ih83rp.webp',
    },
    {
      id: '4',
      name: 'Bloom Picks 1080P Full HD Dual Lens Araç İçi Kamera - 170° Geniş Açı Gece Görüşlü Yol Kayıt Cihazı',
      price: 79.99,
      ...
      inStock: true,
      category: 'electronic',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287407/4_dar3ux.webp',
    },
    {
      id: '5',
      name: 'BLOOMPİCKS Dahili Kablolu 10000mAh 22,5W Hızlı Şarj Powerbank – Type-C & iPhone Uyumlu – LED Ekranlı',
      price: 45.99,
      originalPrice: 69.99,
      rating: 4.6,
      reviews: 156,
      inStock: true,
      category: 'electronic',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287407/5_bwalwv.webp',
    },
    {
      id: '6',
      name: 'Bloom Picks EN7 ANC 4. Nesil Gürültü Engelleyici Bluetooth Kulaklık - K2 Çipli iOS & Android Uyumlu',
      price: 89.99,
      ...
      inStock: true,
      category: 'electronic',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287407/6_os6iro.webp',
    },
    {
      id: '7',
      name: '380 mL Şık Tasarım Çift Katmanlı Paslanmaz Çelik Termos Bardak Sızdırmaz Sıcak-Soğuk Araç Uyumu',
      price: 29.99,
      rating: 4.4,
      reviews: 176,
      inStock: true,
      category: 'sports-outdoors',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287407/7_paqssz.webp',
    },
    {
      id: '8',
      name: '510 mL Şık Tasarım Çift Katmanlı Paslanmaz Çelik Termos Bardak Sızdırmaz Sıcak-Soğuk Araç Uyumu',
      price: 24.99,
      rating: 4.5,
      reviews: 89,
      inStock: true,
      category: 'home-furniture',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287407/8_u2fgyt.webp',
    },
  ];
  ...
  const flashDeals = [
    {
      id: 'fd1',
      name: 'Erkek Comfort Flex Pantolon',
      price: 149.99,
      ...
      inStock: true,
      category: 'male',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287619/9_c7qp8t.webp',
    },
    {
      id: 'fd2',
      name: 'Dayanıklı Metal Gövdeli Mobilya Eşya Taşıma ve Kaldırma Seti 150 KGa kadar',
      price: 99.99,
      ...
      inStock: true,
      category: 'home-furniture',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287619/10_ek0b9n.webp',
    },
    {
      id: 'fd3',
      name: 'Masaüstü İçecek Dağıtıcı Dispenseri Pratik Kola Sebili',
      price: 34.99,
      originalPrice: 59.99,
      rating: 4.7,
      reviews: 234,
      ...
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287619/11_hwrwwt.webp',
    },
    {
      id: 'fd4',
      name: 'Şeffaf Silikon Tampon Ped Seti 3 Boy Kendinden Yapışkanlı Çarpma Önleyici Sessiz Duvar Kapak Koruma',
      price: 69.99,
      originalPrice: 129.99,
      rating: 4.6,
      reviews: 98,
      inStock: true,
      category: 'home-furniture',
      image: 'https://res.cloudinary.com/dpiip2agt/image/upload/v1777287619/12_humgzd.webp',
    },
  ];
            ...
            {categories.map((category) => (
              <Link key={category.name} to={category.link}>
                <GlassCard className="text-center cursor-pointer" hover>
                  <div
                    className={`w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-r ${category.gradient} flex items-center justify-center text-4xl`}
                  >
                    {category.icon}
                  </div>
                  <h3>{category.name}</h3>
        ...
        <div className="container mx-auto px-4 max-w-[1320px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                name: 'Sarah M.',
                review: 'Amazing quality and fast shipping! My favorite online store.',
                rating: 5,
                image: 'https://images.unsplash.com/photo-1556740714-a8395b3bf30f?w=100',
              },
              {
                name: 'John D.',
                review: 'The customer service is outstanding. Highly recommend!',
                rating: 5,
                image: 'https://images.unsplash.com/photo-1556740714-a8395b3bf30f?w=100',
              },
              {
                name: 'Emma L.',
                review: 'Great prices and unique products. Will definitely shop again!',
                rating: 5,
                image: 'https://images.unsplash.com/photo-1556740714-a8395b3bf30f?w=100',
              },
